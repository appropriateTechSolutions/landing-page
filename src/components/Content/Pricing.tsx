...
export const Pricing = () => {
  ...
  return (
    ...
    >
      <div id="pricing" className="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            >
              <blockquote className="mt-2">
                <p className="text-lg leading-relaxed text-white">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore velit soluta illum id aliquam ratione mollitia cum qui nemo necessitatibus?
                </p>
              </blockquote>
            </motion.div>
          </div>
