...
Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officiis, omnis!              </p>
                      ...
                      <div className="flex-1">
                        ...
                        <blockquote className="flex-1 mt-8">
                          <p className="text-lg leading-relaxed text-neutral font-pj">
                            "Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo, voluptas fugiat? Dolorum error, vel ea eaque perspiciatis similique! Unde, ullam?"
                          </p>
                        </blockquote>
                      </div>
